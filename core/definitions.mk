...
@echo -e ${CL_GRN}"target $(PRIVATE_ARM_MODE) C: $(PRIVATE_MODULE) <= $<"
...
@echo -e ${CL_GRN}"target ObjC: $(PRIVATE_MODULE) <= $<"
...
@echo -e ${CL_YLW}"host C: $(PRIVATE_MODULE) <= $<"
...
@echo -e ${CL_YLW} "host ObjC: $(PRIVATE_MODULE) <= $<"
